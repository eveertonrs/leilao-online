...
const LoginAdmin = () => {
  ...
  const { setUsuario } = useContext(AuthContext);
    ...
    try {
      const response = await axios.post('http://localhost:3333/auth/admin/login', { email, senha });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full max-w-sm">
        ...
        <h2 className="block text-gray-700 text-sm font-bold mb-2 text-center text-xl">Admin Sign In</h2>
        <form className="mt-4">
          <div className="mb-4">
